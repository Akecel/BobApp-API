							...
							<div class="panel panel-primary">	
								<div class="panel-body"> 
									<div class="col-sm-12">
											...
											<input type="text" name="lastName" class="form-control" required placeholder="Nom" value="{{ $user->lastName }}"/>
											{!! $errors->first('lastName', '<small class="help-block">:message</small>') !!}
											</div>

											<div class="form-group {!! $errors->has('firstName') ? 'has-error' : '' !!}">
											<input type="text" name="firstName" class="form-control" required placeholder="Prénom" value="{{ $user->firstName }}"/>
											...
											<input type="date" name="birthdate" class="form-control" required placeholder="Date de naissance" value="{{ $user->birthdate }}"/>
											{!! $errors->first('birthdate', '<small class="help-block">:message</small>') !!}
											</div>

											<div class="form-group {!! $errors->has('address') ? 'has-error' : '' !!}">
											<input type="text" name="address" class="form-control" required placeholder="Adresse" value="{{ $user->address }}"/>
											{!! $errors->first('address', '<small class="help-block">:message</small>') !!}
											</div>

											<div class="form-group {!! $errors->has('postal_code') ? 'has-error' : '' !!}">
											<input type="text" name="postal_code" class="form-control" required placeholder="Code postal" value="{{ $user->postal_code }}"/>
											{!! $errors->first('postal_code', '<small class="help-block">:message</small>') !!}
											</div>

											<div class="form-group {!! $errors->has('city') ? 'has-error' : '' !!}">
											<input type="text" name="city" class="form-control" placeholder="Ville" required value="{{ $user->city }}"/>
											{!! $errors->first('city', '<small class="help-block">:message</small>') !!}
											</div>

											<div class="form-group {!! $errors->has('country') ? 'has-error' : '' !!}">
											<input type="text" name="country" class="form-control" placeholder="Pays" required value="{{ $user->country }}"/>
